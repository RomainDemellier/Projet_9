...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
 ...
 // ==================== SequenceEcritureComptable - GET ====================
    ...
    public List<SequenceEcritureComptable> getListSequenceEcritureComptable() {
    	...
    	List<SequenceEcritureComptable> sList = vJdbcTemplate.query(SQLgetListSequenceEcritureComptable, vRM);
    	return sList;
    }
    
    /** SQLgetSequenceEcritureComptableByCodeAndByAnnee */
    private static String SQLgetSequenceEcritureComptableByCodeAndByAnnee;
    public void setSQLgetSequenceEcritureComptableByCodeAndByAnnee(String pSQLgetSequenceEcritureComptableByCodeAndByAnnee) {
    	SQLgetSequenceEcritureComptableByCodeAndByAnnee = pSQLgetSequenceEcritureComptableByCodeAndByAnnee;
    }
    @Override
    public SequenceEcritureComptable getSequenceEcritureComptableByCodeAndByAnnee(String journalCode, int annee) throws NotFoundException {
        ...
        try {
        	vBean = vJdbcTemplate.queryForObject(SQLgetSequenceEcritureComptableByCodeAndByAnnee, vSqlParams, vRM);
