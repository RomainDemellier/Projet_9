...
public interface ComptabiliteDao {
 ...
 // ==================== SequenceEcritureComptable ====================
    ...
    /**
     * Renvoie la derniere valeur d'une sequence_ecriture_comptable
     * @return {@link List}
     * @throws NotFoundException 
     */
    List<SequenceEcritureComptable> getListSequenceEcritureComptable();
    
    SequenceEcritureComptable getSequenceEcritureComptableByCodeAndByAnnee(String code, int annee) throws NotFoundException;
