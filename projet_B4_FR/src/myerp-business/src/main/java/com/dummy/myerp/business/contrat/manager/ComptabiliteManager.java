...
public interface ComptabiliteManager {
    ...
    EcritureComptable getEcritureComptableById(int id);
    
    /** SequenceEcritureComptable */
    
    List<SequenceEcritureComptable> getListSequenceEcritureComptable();
    
    SequenceEcritureComptable getSequenceEcritureComptableByCodeAndByAnnee(String code, int annee) throws NotFoundException, FunctionalException;
